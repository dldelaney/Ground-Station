...
namespace AvionicsInstrumentControlDemo
{
    class AirSpeedIndicatorInstrumentControl : InstrumentControl
    {
        ...
        // Images
        Bitmap bmpCadran = new Bitmap(@"Resources\AirSpeedIndicator_Background.bmp"); // AvionicsInstrumentsControls.AvionicsInstrumentsControlsRessources.AirSpeedIndicator_Background
